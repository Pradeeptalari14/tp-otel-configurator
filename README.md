...
> Design high-performance telemetry pipelines. Build nested configurations for traces/metrics processors, custom exporter endpoints, and verify logs routes.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/otel-configurator/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/otel-configurator/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-otel-configurator.git
cd tp-otel-configurator
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/otel-configurator/) |
